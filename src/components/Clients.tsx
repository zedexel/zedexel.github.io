...
const Clients = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto py-12 md:py-16 relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0 dot-pattern opacity-10"></div>
      
      <div className="relative z-10">
        <h3 className="text-xl md:text-2xl lg:text-3xl font-bold text-dark-50 text-center mb-8 md:mb-12">
              ...
              <div key={index} className="flex-shrink-0 mx-4 md:mx-8">
                ...
                >
                  <img
                    src={logo.src}
                    alt={`Client ${index + 1}`}
                    className={`h-12 md:h-16 w-auto max-w-[100px] md:max-w-[140px] object-contain opacity-60 hover:opacity-100 transition-all duration-300 ${
